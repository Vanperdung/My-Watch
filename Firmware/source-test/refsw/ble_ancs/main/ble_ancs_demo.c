...
{
    ESP_LOGW(BLE_ANCS_TAG, "GAP_EVT, event %d", event);
...
static void gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ESP_LOGW(BLE_ANCS_TAG, "GATTC event: %d\r\n", event);
    ...
    case ESP_GATTC_OPEN_EVT:
        ...
        esp_ble_set_encryption(param->open.remote_bda, ESP_BLE_SEC_ENCRYPT_MITM); // Encrypt remote address
